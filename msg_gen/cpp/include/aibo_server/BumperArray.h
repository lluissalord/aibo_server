/* Auto-generated by genmsg_cpp for file /home/lluis/fuerte/sandbox/aibo_server/msg/BumperArray.msg */
...
struct BumperArray_ {
  ...
  typedef std::vector< ::aibo_server::Bumper_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::aibo_server::Bumper_<ContainerAllocator> >::other >  _paws_type;
  std::vector< ::aibo_server::Bumper_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::aibo_server::Bumper_<ContainerAllocator> >::other >  paws;
...
struct MD5Sum< ::aibo_server::BumperArray_<ContainerAllocator> > {
  ...
  {
    return "600a4fb06adde1d43b5a45da640fd1b2";
  }

  static const char* value(const  ::aibo_server::BumperArray_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0x600a4fb06adde1d4ULL;
  static const uint64_t static_value2 = 0x3b5a45da640fd1b2ULL;
};
...
s << std::endl;
    ...
    for (size_t i = 0; i < v.paws.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::aibo_server::Bumper_<ContainerAllocator> >::stream(s, indent + "    ", v.paws[i]);
    }
  }
};
